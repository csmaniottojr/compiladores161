...
namespace Structures {
	...
	public:
		...
		bool foiRedefinida;
		Symbol( Kinds kind, Types type, bool initialized, bool isArray, bool foiRedefinida ):
			kind( kind ), type( type ),initialized( initialized ), isArray( isArray ), foiRedefinida( foiRedefinida ) {};
		Symbol();
